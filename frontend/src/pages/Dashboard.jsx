    ...
    return (
        <div className='grid grid-cols-1 sm:grid-cols-12 sm:gap-4'>
            <section className='sm:col-span-8'>
                {/* Mobile: collapse */}
                <div className="collapse collapse-arrow rounded-lg sm:hidden overflow-visible">
                    <input type="checkbox" defaultChecked />
                    <div className="collapse-title text-xl font-bold bg-secondary/75 rounded-lg text-base-100 p-2">
                        RECENT PROJECTS
                    </div>
                    <div className="collapse-content p-0 mt-4">
                        {data?.urgent_projects?.length === 0 ? (
                            <div className="group flex flex-col items-center justify-center h-64 bg-secondary/25 hover:bg-primary/75 border-3 border-dashed border-secondary rounded-lg transition-color duration-150 ease-in-out p-4 mb-4">
                ...
                <div className="hidden sm:block">
                    <h1 className="text-4xl text-base-100 bg-secondary/75 rounded-lg font-bold p-4 mb-4">
                        RECENT PROJECTS
                    </h1>
                    {data?.urgent_projects?.length === 0 ? (
                        <div className="group flex flex-col items-center justify-center h-128 bg-secondary/25 hover:bg-primary/75 border-3 border-dashed border-secondary rounded-lg transition-color duration-150 ease-in-out p-4">
                            <i className="fas fa-folder-open text-6xl mb-4 transition-transform duration-200 group-hover:scale-110"></i>
                            <p className="text-xl font-semibold">No urgent projects</p>
                            <p className="text-base text-center">Projects with upcoming deadlines will appear here</p>
                        </div>
            ...
            <section className="sm:col-span-4 space-y-4">
                <details
                    className="collapse collapse-arrow bg-secondary/75 rounded-lg"
                    open={openPanel === 'todo'}
                >
                    <summary
                        className="collapse-title text-xl sm:text-4xl text-base-100 font-bold p-2 sm:p-4"
                    ...
                    <div className="collapse-content space-y-2">
                        {data?.urgent_tasks?.length === 0 ? (
                            <div className="group flex flex-col items-center justify-center h-128 hover:bg-primary/50 border-3 border-dashed border-base-100 rounded-lg transition-all duration-150 ease-in-out p-4">
                ...
                >
                    ...
                    <div className="collapse-content space-y-2">
                        {data?.recent_resources?.length === 0 ? (
                            <div className="group flex flex-col items-center justify-center h-128 hover:bg-primary/50 border-3 border-dashed border-base-100 rounded-lg transition-color duration-150 ease-in-out p-4">
